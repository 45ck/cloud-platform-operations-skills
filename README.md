# cloud-platform-operations-skills

<p align="center">
  <img src="logo.svg" alt="cloud-platform-operations-skills logo" width="128" height="128" />
</p>

<p align="center">
  <img src="banner.svg" alt="cloud-platform-operations-skills banner" width="100%" />
</p>

<p align="center">
  <a href="LICENSE"><img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="MIT License" /></a>
  <img src="https://img.shields.io/badge/skills-10-b91c1c" alt="10 skills" />
  <img src="https://img.shields.io/badge/focus-cloud%20platform%20operations-991b1b" alt="cloud platform operations" />
</p>

A platform-neutral cloud and platform operations skill pack for cloud placement, rollout modes, migration waves, ACL hygiene, patching, and resource lifecycle control.
...
```bash
git clone https://github.com/45ck/cloud-platform-operations-skills.git
cd cloud-platform-operations-skills
bash install.sh
```
...
```text
/public-private-hybrid-cloud-reviewer target hosting model
/iaas-paas-saas-faas-selector new service decision
/blue-green-readiness-reviewer release architecture
/migration-wave-planner datacenter exit program
/patch-management-checker platform patch cycle
/orphaned-resource-auditor cloud account cleanup
```
