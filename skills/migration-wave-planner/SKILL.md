...
purpose: "Plan migration waves that sequence systems, data, dependencies, and operational support in a low-chaos rollout order."
inputs: ["migration scope", "system dependencies", "data movement needs", "support capacity", "risk tolerance"]
outputs: ["wave plan", "dependency order", "cutover assumptions", "support load notes", "wave-by-wave risks"]
handoffs: ["maintenance-window-planner", "update-rollback-planner", "public-private-hybrid-cloud-reviewer"]
---
# migration-wave-planner

## Purpose
Plan migration waves that sequence systems, data, dependencies, and operational support in a low-chaos rollout order.
