---
name: "resource-lifecycle-planner"
pack: "cloud-platform-operations-pack"
purpose: "Plan how cloud resources are provisioned, tagged, scaled, rotated, retired, and audited across their full lifecycle."
inputs: ["resource inventory", "environment model", "ownership details", "scaling expectations", "retention or shutdown rules"]
outputs: ["lifecycle policy", "ownership map", "tagging or naming rules", "retirement triggers", "automation opportunities"]
handoffs: ["orphaned-resource-auditor", "patch-management-checker", "update-rollback-planner"]
---
