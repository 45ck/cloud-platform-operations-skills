---
name: "orphaned-resource-auditor"
pack: "cloud-platform-operations-pack"
purpose: "Audit cloud resources for stale, unowned, unused, or risky assets that should be tagged, reclaimed, or removed."
inputs: ["resource inventory", "ownership metadata", "usage data", "environment scope", "retention rules"]
outputs: ["orphaned asset findings", "ownership gaps", "reclamation candidates", "risk summary", "cleanup actions"]
handoffs: ["resource-lifecycle-planner", "acl-maintenance-reviewer", "patch-management-checker"]
---
