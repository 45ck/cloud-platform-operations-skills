---
name: "blue-green-readiness-reviewer"
pack: "cloud-platform-operations-pack"
purpose: "Review whether a service is actually ready for blue/green or similar low-downtime deployment patterns."
inputs: ["deployment topology", "traffic switching method", "state handling approach", "observability setup", "rollback expectations"]
outputs: ["blue-green readiness summary", "blocking gaps", "state or data risks", "traffic cutover notes", "recommendation"]
handoffs: ["update-rollback-planner", "maintenance-window-planner", "migration-wave-planner"]
---
# blue-green-readiness-reviewer

## Purpose
Review whether a service is actually ready for blue/green or similar low-downtime deployment patterns.
...
## Deliverables
- blue-green readiness summary
- blocking gaps
- state or data risks
- traffic cutover notes
- recommendation
