---
name: "update-rollback-planner"
pack: "cloud-platform-operations-pack"
purpose: "Plan how platform, infrastructure, or service updates are deployed, validated, and rolled back under real operational constraints."
inputs: ["update scope", "validation checks", "rollback mechanism", "dependency impacts", "window or timing constraints"]
outputs: ["update execution plan", "validation checkpoints", "rollback path", "dependency warnings", "operator notes"]
handoffs: ["blue-green-readiness-reviewer", "maintenance-window-planner", "patch-management-checker"]
---
