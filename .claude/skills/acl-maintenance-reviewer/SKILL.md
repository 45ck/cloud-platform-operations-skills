---
name: "acl-maintenance-reviewer"
pack: "cloud-platform-operations-pack"
purpose: "Review cloud ACLs, security groups, firewall rules, and permissions for drift, unnecessary exposure, and maintenance risk."
inputs: ["access control inventory", "network or identity rules", "change history", "approved access patterns", "exception list"]
outputs: ["acl review findings", "exposure or drift issues", "cleanup recommendations", "least-privilege notes", "follow-up actions"]
handoffs: ["orphaned-resource-auditor", "patch-management-checker", "resource-lifecycle-planner"]
---
